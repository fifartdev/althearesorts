...
const galleryItems = [
  ...
  { src: '/images/new-images/althea-deluxe-double1.jpg',  caption: 'Deluxe Double',         category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double2.jpg',  caption: 'Room Interior',         category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double3.jpg',  caption: 'Room Details',          category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double4.jpg',  caption: 'Balcony Views',         category: 'Rooms & Suites',   wide: true },
  { src: '/images/new-images/althea-deluxe-double5.jpg',  caption: 'Deluxe with Pool',      category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double6.jpg',  caption: 'Room Terrace',          category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double7.jpg',  caption: 'Suite Details',         category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double8.jpg',  caption: 'Loft Suite',            category: 'Rooms & Suites',   wide: true },
  { src: '/images/new-images/althea-deluxe-double9.jpg',  caption: 'Living Space',          category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double10.jpg', caption: 'Room Comfort',          category: 'Rooms & Suites',   wide: false },
  { src: '/images/new-images/althea-deluxe-double11.jpg', caption: 'Private Terrace',       category: 'Rooms & Suites',   wide: false },
  ...
  { src: '/images/gallery/stand-double.jpg',   caption: 'Standard Double',     category: 'Rooms & Suites',    wide: false },
  { src: '/images/gallery/deluxe-doubl.jpg',  caption: 'Deluxe Double',       category: 'Rooms & Suites',    wide: false },
  { src: '/images/gallery/superior-sv.jpg',   caption: 'Superior Sea View',   category: 'Rooms & Suites',    wide: false },
  { src: '/images/gallery/jspool.jpg',         caption: 'Junior Suite Pool',   category: 'Rooms & Suites',    wide: false },
  { src: '/images/gallery/loft-for-2-a.jpg',  caption: 'Loft Suite for Two',  category: 'Rooms & Suites',    wide: true },
  { src: '/images/gallery/loft-for-2-b.jpg',  caption: 'Loft — Upper Level',  category: 'Rooms & Suites',    wide: false },
  { src: '/images/gallery/loft-for-4-a.jpg',  caption: 'Loft Suite for Four', category: 'Rooms & Suites',    wide: false },
  { src: '/images/gallery/loft-for-4-b.jpg',  caption: 'Loft — Living Area',  category: 'Rooms & Suites',    wide: false },
  { src: '/images/gallery/mpanio.jpg',         caption: 'Bathroom',            category: 'Rooms & Suites',    wide: false },

  { src: '/images/gallery/pool-terrace.jpg',  caption: 'Pool & Terrace',      category: 'Pool & Exterior',   wide: true },
  { src: '/images/gallery/pool-1.jpg',         caption: 'The Pool',            category: 'Pool & Exterior',   wide: false },
  { src: '/images/gallery/pool-2.jpg',         caption: 'Pool — Day',          category: 'Pool & Exterior',   wide: false },
  { src: '/images/gallery/pool-3.jpg',         caption: 'Poolside',            category: 'Pool & Exterior',   wide: false },
  { src: '/images/gallery/pool-night-1.jpg',  caption: 'Pool at Night',       category: 'Pool & Exterior',   wide: false },
  { src: '/images/gallery/pool-night-2.jpg',  caption: 'Night Swimming',      category: 'Pool & Exterior',   wide: false },

  { src: '/images/gallery/corridor-1.jpg',    caption: 'Hotel Corridor',      category: 'Lobby & Reception', wide: false },
  { src: '/images/gallery/corridor-2.jpg',    caption: 'Corridor',            category: 'Lobby & Reception', wide: false },
]
