...
const galleryItems = [
  ...
  { src: '/images/gallery/deluxe%20doubl.jpg',            caption: 'Deluxe Double',           category: 'Rooms & Suites',      wide: false },
  { src: '/images/gallery/Superior%20sv.jpg',             caption: 'Superior Sea View',       category: 'Rooms & Suites',      wide: false },
  { src: '/images/gallery/JSPOOL.jpg',                    caption: 'Junior Suite Pool',       category: 'Rooms & Suites',      wide: false },
  { src: '/images/gallery/loft%20for%202..jpg',           caption: 'Loft Suite for Two',      category: 'Rooms & Suites',      wide: true },
  { src: '/images/gallery/loft%20for%202....jpg',         caption: 'Loft — Upper Level',      category: 'Rooms & Suites',      wide: false },
  { src: '/images/gallery/loft%20for%204.jpg',            caption: 'Loft Suite for Four',     category: 'Rooms & Suites',      wide: false },
  { src: '/images/gallery/loft%20for%204-.jpg',           caption: 'Loft — Living Area',      category: 'Rooms & Suites',      wide: false },
  { src: '/images/gallery/mpanio...jpg',                  caption: 'Bathroom',                category: 'Rooms & Suites',      wide: false },

  { src: '/images/gallery/pool....jpg',                   caption: 'Pool & Terrace',          category: 'Pool & Exterior',     wide: true },
  { src: '/images/gallery/pool%20.jpg',                   caption: 'The Pool',                category: 'Pool & Exterior',     wide: false },
  { src: '/images/gallery/pool%202.jpg',                  caption: 'Pool — Day',              category: 'Pool & Exterior',     wide: false },
  { src: '/images/gallery/pool%203.jpg',                  caption: 'Poolside',                category: 'Pool & Exterior',     wide: false },
  { src: '/images/gallery/pool%20night.jpg',              caption: 'Pool at Night',           category: 'Pool & Exterior',     wide: false },
  { src: '/images/gallery/pool%20night..jpg',             caption: 'Night Swimming',          category: 'Pool & Exterior',     wide: false },

  { src: '/images/gallery/corridor.jpg',                  caption: 'Hotel Corridor',          category: 'Lobby & Reception',   wide: false },
  { src: '/images/gallery/corridor..jpg',                 caption: 'Corridor',                category: 'Lobby & Reception',   wide: false },
]
