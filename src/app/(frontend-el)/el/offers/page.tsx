...
export const metadata = genMeta({
  ...
  description: 'Κλείστε απευθείας με την Althea Resorts για εγγυημένα καλύτερη τιμή. Χωρίς μεσάζοντες, χωρίς προμήθειες — κάντε κράτηση μέσω ιστοσελίδας, τηλεφώνου ή email.',
  keywords: ['προσφορές Althea Resorts', 'έκπτωση ξενοδοχείο Κορινθία', 'άμεση κράτηση Ελλάδα', 'καλύτερη τιμή ξενοδοχείο'],
