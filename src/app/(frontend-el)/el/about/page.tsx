        ...
        <div className="container-narrow">
          ...
          <ScrollReveal delay={150}>
            <p className="text-body-refined">
              ...
              <a href="/el/location" className="text-[#ad8b27] hover:underline font-light">μόλις εξήντα λεπτά από την Αθήνα</a>,
              {' '}αλλά ταυτόχρονα σε έναν κόσμο εντελώς μακριά από
            ...
            <div>
              ...
              <ScrollReveal delay={200}>
                ...
                <p className="text-body-refined">
                  ...
                  Και μια κουζίνα που ξεκινά κάθε πρωί
            ...
            <div className="lg:col-span-5">
              ...
              <ScrollReveal delay={200}>
                ...
                <p className="text-sm font-light text-white/60 leading-relaxed mb-5">
                  ...
                  δίπλα σας.{' '}
                  <a href="/el/location" className="text-[#ad8b27]/70 hover:text-[#ad8b27] transition-colors duration-200 font-light">
                    Η Αθήνα απέχει μόλις εξήντα λεπτά.
                  </a>
                </p>
