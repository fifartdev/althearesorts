...
const galleryItems = [
  ...
  { src: '/images/new-images/althea-deluxe-double1.jpg',  caption: 'Deluxe Double',             category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double2.jpg',  caption: 'Εσωτερικό Δωματίου',       category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double3.jpg',  caption: 'Λεπτομέρειες Δωματίου',    category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double4.jpg',  caption: 'Θέα Βεράντας',             category: 'Δωμάτια & Σουίτες',         wide: true },
  { src: '/images/new-images/althea-deluxe-double5.jpg',  caption: 'Deluxe με Πισίνα',         category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double6.jpg',  caption: 'Ταράτσα Δωματίου',         category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double7.jpg',  caption: 'Λεπτομέρειες Σουίτας',     category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double8.jpg',  caption: 'Loft Suite',                category: 'Δωμάτια & Σουίτες',         wide: true },
  { src: '/images/new-images/althea-deluxe-double9.jpg',  caption: 'Καθιστικό',                category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double10.jpg', caption: 'Άνεση Δωματίου',           category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/new-images/althea-deluxe-double11.jpg', caption: 'Ιδιωτική Βεράντα',         category: 'Δωμάτια & Σουίτες',         wide: false },
  ...
  { src: '/images/gallery/deluxe-doubl.jpg', caption: 'Deluxe Double',            category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/gallery/superior-sv.jpg',  caption: 'Superior Sea View',        category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/gallery/jspool.jpg',        caption: 'Πισίνα Junior Suite',      category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/gallery/loft-for-2-a.jpg', caption: 'Loft Suite για Δύο',       category: 'Δωμάτια & Σουίτες',         wide: true },
  { src: '/images/gallery/loft-for-2-b.jpg', caption: 'Loft — Επάνω Επίπεδο',     category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/gallery/loft-for-4-a.jpg', caption: 'Loft Suite για Τέσσερις',  category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/gallery/loft-for-4-b.jpg', caption: 'Loft — Καθιστικό',          category: 'Δωμάτια & Σουίτες',         wide: false },
  { src: '/images/gallery/mpanio.jpg',        caption: 'Μπάνιο',                   category: 'Δωμάτια & Σουίτες',         wide: false },

  { src: '/images/gallery/pool-terrace.jpg', caption: 'Πισίνα & Ταράτσα',         category: 'Πισίνα & Εξωτερικοί Χώροι', wide: true },
  { src: '/images/gallery/pool-1.jpg',        caption: 'Η Πισίνα',                 category: 'Πισίνα & Εξωτερικοί Χώροι', wide: false },
  { src: '/images/gallery/pool-2.jpg',        caption: 'Πισίνα — Ημέρα',           category: 'Πισίνα & Εξωτερικοί Χώροι', wide: false },
  { src: '/images/gallery/pool-3.jpg',        caption: 'Πλευρά Πισίνας',           category: 'Πισίνα & Εξωτερικοί Χώροι', wide: false },
  { src: '/images/gallery/pool-night-1.jpg', caption: 'Πισίνα τη Νύχτα',          category: 'Πισίνα & Εξωτερικοί Χώροι', wide: false },
  { src: '/images/gallery/pool-night-2.jpg', caption: 'Βραδινή Κολύμβηση',        category: 'Πισίνα & Εξωτερικοί Χώροι', wide: false },

  { src: '/images/gallery/corridor-1.jpg',   caption: 'Διάδρομος Ξενοδοχείου',    category: 'Λόμπι & Ρεσεψιόν',          wide: false },
  { src: '/images/gallery/corridor-2.jpg',   caption: 'Διάδρομος',                 category: 'Λόμπι & Ρεσεψιόν',          wide: false },
]
